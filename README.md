...
- **Product Profitability**: Detailed breakdown across 15+ product categories
- **Regional Performance**: State-level profit analysis
- **Sales Trends**: Year-over-year comparison (2020-2023)
- **Customer Segmentation**: Consumer, Corporate, and Home Office breakdown

### **Interactive Insights**
- Product category drill-down capabilities
...
- State-level profit distribution patterns
- Furniture category performance breakdown (Chairs, Tables, Bookcases)

### **Sales Performance**
- Tracking of sales trends across 4-year period
